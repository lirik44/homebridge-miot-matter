...
class LightService extends AbstractService {
  ...
  supportsAdaptiveLighting() {
    // Adaptive lighting is HomeKit moving the colour temperature through the day, and it needs
    // both: a lamp with no dimmer has nothing to follow the brightness with.
    return this.supportsBrightness() && this.supportsColorTemperature();
  }
