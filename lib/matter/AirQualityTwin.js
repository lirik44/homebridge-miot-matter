...
/** 0 means the measurement was taken in air, which is the only medium these devices measure. */
const MEASURED_IN_AIR = 0;
...
class AirQualityTwin extends MatterTwin {
  ...
  state() {
    ...
    return {
      ...
      pm25ConcentrationMeasurement: { measuredValue: pm25, measurementMedium: MEASURED_IN_AIR },
    };
  }
